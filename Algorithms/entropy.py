...
class Entropy(Algorithm):
    ...
    def get_pattern(self, guess: Word, secret_word: Word, game_state, game_logic: AbstractWordleLogic):
    ...
    def get_pattern_probs(self, guess: Word, game_state, game_logic: AbstractWordleLogic) -> Dict[
        tuple, float]:
    ...
    def get_expected_info(self, guess: Word, game_state, game_logic: AbstractWordleLogic) -> float:
    ...
    def get_action(self, game_state, game_logic: AbstractWordleLogic) -> Word:
